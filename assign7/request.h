 ...
 */
  int ingestHeader(std::istream& instream, const std::string& clientIPAddress);
 ...
 */
  ...
  void setForwardToProxy(bool inp) { forwardToProxy = inp; }

  bool forwardContainsIP(const std::string& clientIPAddress);
