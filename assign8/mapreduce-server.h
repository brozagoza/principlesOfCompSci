...
class MapReduceServer {
 ...
 private:
  ...
  void stageMappedFiles(const std::string& directory, std::list<std::string>& files) throw(); // reducer
  ...
  void spawnReducers() throw(); // reducer
  ...
  std::list<std::string> reducerUnprocessed;
